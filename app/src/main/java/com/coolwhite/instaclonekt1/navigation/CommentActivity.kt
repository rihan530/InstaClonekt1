...
class CommentActivity : AppCompatActivity() {
    ...
    fun commentAlarm(destinationUid : String, message : String) {
        ...
        var msg = FirebaseAuth.getInstance().currentUser?.email + "이 " + getString(R.string.alarm_comment) + message
    ...
    inner class CommentRecyclerviewAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
        ...
        override fun onBindViewHolder(p0: RecyclerView.ViewHolder, p1: Int) {
            ...
            FirebaseFirestore.getInstance().collection("profileImages").document(comments[p1].uid!!).get().addOnCompleteListener { task ->
